...
class GCodeFile(MakesmithInitFuncs):
    ...
    def addPoint(self, x, y):
        ...
        '''
        self.line[-1].points.append((x*self.canvasScaleFactor,y*self.canvasScaleFactor*-1.0))
    ...
    def drawLine(self,gCodeLine,command):
        ...
        if True:
            ...
            if self.isNotReallyClose(self.xPosition,xTarget) or self.isNotReallyClose(self.yPosition,yTarget):
                ...
                if command == 'G00':
                    ...
                    #print "here"
                    if len(self.line)==0 or self.line[-1].dashed or self.line[-1].type!='line':
                        self.line.append(Line()) #points = (), width = 1, group = 'gcode')
                        self.line[-1].type="line"
                        self.addPoint(self.xPosition,self.yPosition)
...
#            print "here"
        ...
        if (True):
            for line in self.line:
                _str= "Type:"+str(line.type)+", Color:"+str(line.color)+", Dashed:"+str(line.dashed)+"..."
