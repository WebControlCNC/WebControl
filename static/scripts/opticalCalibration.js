...
function drawCalibration(){
    ...
    gridLinesOptical.add(draw.line(0,0,96,0).stroke({width:.1, color: '#000'}))
    gridLinesOptical.add(draw.line(0,48,96,48).stroke({width:.1, color: '#000'}))
    gridLinesOptical.add(draw.line(0,24,96,24).stroke({width:.1, color: '#000'}))
    gridLinesOptical.add(draw.line(0,0,0,48).stroke({width:.1, color: '#000'}))
    gridLinesOptical.add(draw.line(24,0,24,48).stroke({width:.1, color: '#000'}))
    gridLinesOptical.add(draw.line(48,0,48,48).stroke({width:.1, color: '#000'}))
    gridLinesOptical.add(draw.line(72,0,72,48).stroke({width:.1, color: '#000'}))
    gridLinesOptical.add(draw.line(96,0,96,48).stroke({width:.1, color: '#000'}))
    gridLinesOptical.center(originXOptical,originYOptical)
    //gridLines.scale(scale,scale)

    sledOptical = drawOptical.group()
    sledOptical.add(draw.line(1.5,-0.0,1.5,3.0).stroke({width:.1,color:"#F00"}))
    sledOptical.add(draw.line(-0.0,1.5,3.0,1.5).stroke({width:.1,color:"#F00"}))
    sledOptical.add(draw.circle(3).stroke({width:.1,color:"#F00"}).fill({color:"#fff",opacity:0}))
